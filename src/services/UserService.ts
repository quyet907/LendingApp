...
export class UserService {
  public static login(user: string, pass: string): Promise<BaseUserWithJwt> {
    ...
    return axios
      .post(`${config.apiGateway.user}/public/user/login`, {
  ...
  public static register(
    ...
    return axios
      .post(`${config.apiGateway.user}/public/user/register`, {
        loginType: "phonenumber",
        username: userName,
        password: password,
  ...
  public static checkJWT = (jwt: string): Promise<boolean | null> => {
    return axios
      .get(`${config.apiGateway.user}/user/me`, {
        headers: {
  ...
  public static sendOTP(phone: string): Promise<string> {
    return axios
      .post(`${config.apiGateway.user}/public/user/sendOTP`, { mobile: phone })
      .then((res) => {
  ...
  public static verifyOTP(
    ...
    return axios
      .post(`${config.apiGateway.user}/public/user/verifyOTP`, {
        code: OTP,
  ...
  public static checkExits(phone: string): Promise<boolean> {
    return axios
      .get(`${config.apiGateway.user}/public/user/checkExist`, {
        params: {
          username: phone,
        },
      })
  ...
  public static setPassword(
    ...
    return axios
      .post(`${config.apiGateway.user}/public/user/setPassword`, {
        username: username,
        password: password,
        otpCode: codeOTP,
      })
